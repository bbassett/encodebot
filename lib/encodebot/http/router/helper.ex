defmodule Encodebot.HTTP.Router.Helper do
    ...
    quote do
      ...
      def match(%Plug.Conn{} = conn, _opts) do
        case match(conn.method, conn.path_info) do
          ...
          nil ->
            conn
            |> put_private(:mazurka_route, Encodebot.Resource.Error.GET)
            |> put_private(:mazurka_resource, Encodebot.Resource.Error.GET)
